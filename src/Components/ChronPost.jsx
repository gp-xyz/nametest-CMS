  ...
  return (
    ...
    <div className="m-2 p-2 ">
      {post.img_url ? (
            ...
            <div className="rounded-xl w-full h-64 relative bg-gradient-to-r from-slate-700 to-slate-500 hover:to-white hover:cursor-pointer">
              <img src={post.img_url} className="rounded-xl  w-full h-full object-cover opacity-20" />
              <div className="absolute inset-0 flex items-top justify-start p-3 m-3">
                <p className="text-white text-center font-bold text-3xl md:text-5xl blogtitle">{post.title.rendered} </p>
              </div>
